...
namespace Microsoft.ApplicationInsights.Profiler.Core.Utilities
{
    internal class RuntimeCompatibilityUtility : ICompatibilityUtility
    {
            ...
            ILogger<RuntimeCompatibilityUtility> logger)
        {
            ...
            this._versionProvider = versionProvider ?? throw new ArgumentNullException(nameof(versionProvider));
            this._netCoreAppVersion = netCoreAppVersion ?? throw new ArgumentNullException(nameof(netCoreAppVersion));
        }
