...
{
    ServiceProfilerIndex CreateServiceProfilerIndex(string fileId, string stampId, DateTimeOffset sessionId, Guid appId, Guid artifactId, IProfilerSource profilerSource);
